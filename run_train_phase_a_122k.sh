#!/usr/bin/env bash
# TinyDraft Phase A Round 2: 122K context with RoPE scaling
# Resume from 16K checkpoint, train at 122K
# A100 80GB
set -euo pipefail
...
OUTPUT_DIR="/workspace/tf/checkpoints/tinydraft_phase_a_122k"
mkdir -p "$OUTPUT_DIR"

echo "========================================="
echo "  TinyDraft Phase A Round 2"
echo "  Context: 122K (prefix=124672, cont=256)"
echo "  RoPE: linear scaling factor=64"
...
echo ""
echo "========================================="
echo "  Phase A Round 2 (122K) Complete!"
echo "========================================="
